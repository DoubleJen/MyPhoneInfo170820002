package tw.adouble.app.helloworld.myphoneinfo170820002;
...
//https://developer.android.com/training/permissions/requesting.html
    ...
    private void init(){
        ...
        while(c3.moveToNext()){
            ...
            Date data1 = new Date(Long.parseLong(strDate));
            int hh = data1.getHours();
            int mm = data1.getMinutes();
            int ss = data1.getSeconds();
            String hms = hh + " : " + mm + " : " + ss;
